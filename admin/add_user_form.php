...
$profile_pic= $_FILES['file']['name'];
 ...
 {
   $query="insert into directory(name,designation,email,mobile,state,department,gender,address,password,profile_pic)values('$name','$designation','$email','$mobile','$state','$department','$gender','$address','$password','$profile_pic')";
   $sql=mysqli_query($conn,$query);
   move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$profile_pic);

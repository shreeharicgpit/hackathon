                                              ...
                                              <div class="form-group">
                                                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                                  <form action="select_member.php" method="post">
                                                    <input type="hidden" value="<?=$selected_id?>" name="select">
                                                    <input type="hidden" value="<?=$meeting_code?>"
                                                    name="meeting_code">
          ...
          <div class="row">
             ...
             <form id="demo-form" data-parsley-validate method="post">
                                            ...
                                            <label for="Meeting Description">Meeting Description :</label>
                                             ...
                                             <form action="email/mail1.php" method="post">
                                                <input type="hidden" name="send" value="<?=$selected_id?>">
